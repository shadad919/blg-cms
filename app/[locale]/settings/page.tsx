    ...
    <ProtectedRoute>
      <Layout>
        <div className="space-y-6">
          ...
          {/* Tabs */}
          <div className="flex gap-1 p-1 rounded-xl bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-600">
            {tabs.map((tab) => {
              const Icon = tab.icon
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-lg font-medium transition-colors ${
                    isActive
                      ? 'bg-white dark:bg-gray-700 text-primary shadow-sm dark:shadow-none'
                      : 'text-gray-600 dark:text-gray-400 hover:text-text dark:hover:text-gray-200'
                  }`}
                >
